...
const contactCards = [
  ...
  },
  {
    title: "Instagram",
    value: "@cosset",
    href: "https://instagram.com/cosset",
    icon: (
  ...
  {
    title: "Email",
    value: "hello@cosset.in",
    href: "mailto:hello@cosset.in",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="contact" className="py-16 md:py-24 bg-stone-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {contactCards.map((card) => (
            <a
              ...
              className="flex flex-col items-center p-6 bg-white rounded-lg border border-stone-200 shadow-sm card-hover"
            >
        ...
        <div className="max-w-xl mx-auto bg-white rounded-lg border border-stone-200 shadow-sm p-6 md:p-8">
          <h3 className="text-xl font-semibold text-stone-800 mb-4">Send a message</h3>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {status === "sent" && <p className="text-green-600 text-sm">Thank you! We&apos;ll get back soon.</p>}
