    ...
    <section id="about" className="py-16 md:py-24 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative aspect-[4/3] rounded-lg overflow-hidden bg-stone-200 dark:bg-slate-800">
            <Image
          ...
          <div>
            ...
            <p className="text-stone-600 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <p className="text-stone-600 dark:text-slate-300 leading-relaxed mb-6">
