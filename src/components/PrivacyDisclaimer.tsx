export default function PrivacyDisclaimer() {
  return (
    <section id="legal" className="py-16 md:py-20 bg-white dark:bg-slate-900 border-t border-stone-200 dark:border-slate-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <p className="section-tag mb-3">Legal</p>
        <h2 className="section-title mb-8">Privacy & Disclaimer</h2>

        <div className="space-y-8 text-stone-600 dark:text-slate-300 leading-relaxed">
          <div>
